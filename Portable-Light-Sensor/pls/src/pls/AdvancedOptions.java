            ...
            switch(index){
                case 0: 
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(this, "Files Are Syncing To USB Drive!", "Sync Started!", JOptionPane.PLAIN_MESSAGE);
                    } catch (IOException ex) {
                    }
                    break;
                case 1:
                    ShouldIDie delete = new ShouldIDie();
                    break;
                case 2:
        ...
        if (evt.getKeyChar() == '\n'){
            ...
            switch(index){
                case 0: //Yes
                    ...
                    String [] cleanArchCmd = { "/bin/bash", "-c", "rm -rf /home/pi/ArchivedTests/*"};
                    try {
